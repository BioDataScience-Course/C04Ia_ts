...
L'évolution de l'activité cérébrale du patient schizophrénique est représenté ci-dessous pour les 120 jours de l'étude. Le trait vertical pointillé rouge indique à partir de quel moment le traitement médicamenteux est appliqué.
...
[] -   Durant les 60 premiers jours (période pré-traitement) l'activité cérébrale est stable.
[] -   Durant les 60 premiers jours (période pré-traitement) l'activité cérébrale est supérieure à la moyenne sur l'ensemble de la période observée.
...
<!--% Séparez la série en schizo_ts1 du jour 1 au jour 60 et schizo_ts2 du jour 61 au jour 120. -->
...
<!--% Étudiez les tendances générales sur schizo_ts1 et schizo_ts2 en bootstrapant 999 fois (y compris les graphiques). -->

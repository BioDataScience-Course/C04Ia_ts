...
[] -   Un cycle mensuel significatif est observé de manière significative.
[] -   Un cycle trimestriel significatif est observé de manière significative.
[] -   Un cycle semestriel significatif est observé de manière significative.
[] -   Un cycle annuel significatif est observé de manière significative.
[] -   Un cycle mensuel et un cycle trimestriel sont observés de manière significative.
[] -   Un cycle à un an et un autre à trois ans sont observés de manière significative.
[] -   Des cycles à un, trois et cinq mois sont observés de manière significative.
[] -   Des cycles à un, trois et cinq ans sont observés de manière significative.}-")
```
